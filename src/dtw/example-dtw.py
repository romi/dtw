...
class test20_6:
  seq1 = [133,101,114,138,85,143,122,115,122,124,128,109,145,129,132,132,128,137,129,117,136,146,116,157,125,119,263,233,285,120,110,147,131,143,268,222,271,140,133,141,129,133,138,138,162,133,145,136,145,142,129,119,136,136,148,136,118,128,138,121,164,111,129,148,115]
  seq2 = np.full((65,),137)
  disttype = "ANGULAR" # Instead of EUCLIDEAN
  constraints = "MERGE_SPLIT"
  freeends=(0,1)
...
dtw.runtest(test20_62 , freeendsflag = True, bpflag = False, ldflag=False, graphicoptimalpathflag=True, graphicseqalignment=True)
